    ...
    <div className="w-full min-h-screen !pt-15 sm:px-4">
      <div className="container mx-auto p-4 flex flex-col gap-5">
        <div className="w-full">
          ...
          <div className="w-full overflow-x-auto hide-scrollbar mt-2">
        ...
        <div className="w-full flex items-center justify-end">
          <Pagination className="overflow-x-auto hide-scrollbar">
            <Pagination.Prev
...
//   const generatePaginationItems = () => {
//     const items = [];
//     const maxPagesToShow = 5; // Current page ke aas paas ke kitne pages dikhane hain

//     if (totalPages <= 10) {
//       // Agar total pages 10 se kam hain to sab dikhado
//       for (let i = 1; i <= totalPages; i++) {
//         items.push(
...
//       <div className="container mx-auto p-4 flex flex-col gap-5">
//         <h1 className="!font-semibold !text-lg !text-gray-800">
//           Applied Jobs (<span className="text-[var(--dark-bg)]">{applications.length}</span>)
//         </h1>
...
//           <tbody>
//             {pageData.map((app, index) => (
//               <tr key={app.id} className="text-gray-700 border-b hover:bg-gray-100">
//                 <td className="p-3">{(page - 1) * jobsPerPage + index + 1}</td>
//                 <td className="p-3">{app.company}</td>
//                 <td className="p-3">{app.position}</td>
//                 <td className="p-3">{app.applyDate}</td>
