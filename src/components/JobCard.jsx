    ...
    <div className="w-full hover:!shadow-xl cursor-pointer !bg-white !px-3 !py-4 !rounded-md !shadow-md">
      <div className="w-full flex items-center justify-between">
        ...
        <Button
          ...
          className={`!text-md ${
            saved ? "!bg-black !text-gray-100" : "!text-gray-800 !bg-transparent"
          } !border !border-gray-500 !rounded-full !p-2 hover:!shadow-md`}
          isIcon={true}
          iconPosition={"center"}
      ...
      <div className="flex items-center gap-2 !py-2">
        <img
          src={data?.logo}
          className="w-10 !border-4 !border-gray-900 h-10 object-cover rounded-full"
        />
      ...
      <div className="py-2">
        <Link to={`/job-detail/2`} className="!no-underline !text-[var(--dark-bg)]">
          {" "}
          <Button
            isText={true}
            text={"Detail"}
